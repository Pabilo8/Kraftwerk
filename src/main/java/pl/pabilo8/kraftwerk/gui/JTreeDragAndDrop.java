 ...
 * @since 16.08.2021
 */
public class JTreeDragAndDrop extends JTree implements SearchListener
{

	public JTreeDragAndDrop(Object[] value)
	{
		super(value);
		init();
	}

	public JTreeDragAndDrop(Vector<?> value)
	{
		super(value);
		init();
	}

	public JTreeDragAndDrop(Hashtable<?, ?> value)
	{
		super(value);
		init();
	}

	public JTreeDragAndDrop(TreeNode root)
	{
		super(root);
		init();
	}

	public JTreeDragAndDrop(TreeNode root, boolean asksAllowsChildren)
	{
		super(root, asksAllowsChildren);
		init();
	}

	public JTreeDragAndDrop(TreeModel newModel)
	{
		super(newModel);
		init();
	}
